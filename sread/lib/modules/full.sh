...
run() {
    ...
    local modules=(ports services packages pkgverify users firewall sysctl cron setuid world tamper spyproc preload kmod ebpf autostart netconn desktop xattr mounts dnstun)
